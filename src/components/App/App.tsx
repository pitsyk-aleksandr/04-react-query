...
// Toast-повідомлення про "no movies found" викликається безпосередньо всередині queryFn.
// Це може спричинити множинні повідомлення або неочікувану поведінку,
// оскільки React Query може викликати queryFn декілька разів (наприклад, у фонових оновленнях).
// Повідомлення слід викликати у useEffect, який слідкує за isSuccess та data,
// а не всередині самої fetch-функції.
// ------------------------------------------------------------------------------------------
